        ...
        <div class="card shadow-sm p-4">
            <div class="row">
                ...
                <div class="col-md-3 text-center">
                    ...
                    <h5 class="mt-2">ชื่อผู้ใช้ <strong>{{ $user->name }}</strong></h5>
                ...
                <a href="{{-- route('student.editProfile', ['id' => $user->student_id]) --}}" class="btn btn-primary">แก้ไขข้อมูลส่วนตัว</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12 mt-4">
            <div class="card shadow-sm p-4">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{-- route('location_infos.editProfile', ['id' => $user->student_id]) --}}" class="btn btn-primary">แก้ไขข้อมูลสถานที่ฝึกงาน</a>
                </div>
                <br>
                <div class="row">
                    <div class="col-md-12">
                        <p><strong>สถานที่ฝึกงาน: </strong>
                    ...
                    <div class="col-md-12">
                        <p><strong>เบอร์โทร/แฟกซ์: </strong>
